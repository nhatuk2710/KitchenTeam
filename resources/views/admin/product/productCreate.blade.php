            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="{{url("admin/product/productpost")}}" method="post" enctype="multipart/form-data" novalidate>
                                @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("product_name"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="product_name"
                                               placeholder="Product Name" value="{{old("product_name")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("product_desc"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="product_desc"
                                               placeholder="" value="{{old("product_desc")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("price"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="price"
                                               placeholder="" value="{{old("price")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("quantity"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="quantity"
                                               placeholder="" value="{{old("quantity")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("thumbnail"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="thumbnail"
                                               placeholder="" value="{{old("thumbnail")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("gallery"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="gallery"
                                               placeholder="" value="{{old("gallery")}}" required="required" />
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("image"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               ...
                                               placeholder="" value="{{old("image")}}" required="required" />
                                    </div>
                                </div>
