            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="{{url("admin/order/editOrder",['id'=>$brand->id])}}" method="post" novalidate>
                                @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control @if($errors->has("brand_name"))is-invalid @endif" data-validate-length-range="6" data-validate-words="2"
                                               name="brand_name"
